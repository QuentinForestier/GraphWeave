...
import com.forestier.backend.dto.ApiErrorResponse;
import com.forestier.backend.helper.JwtHelper;
import com.forestier.backend.services.UserDetailsServiceImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                ...
                username = JwtHelper.extractEmail(token); //Email is used as username
            }
